...
echo $EndTime;
echo $StartTime;
//$start_date  		 = $_POST[sTime];
//$end_date  		 = $_POST[eTime];
//$Start_time = $_POST[StartTime];
//$End_time   = $_POST[EndTime];



$datetime1 = $year."-".$kwm."-".$day;
$datetime2 = $eyear."-".$ekwm."-".$eday;
...
//$datetime2 = date("m-d-Y", $timestamp2);

//$Start_time	= date ("H:i:s", $Start_time1);
//$End_time	= date ("H:i:s", $End_time1);


//$combinedEDT = date('Y-m-d H:i:s', strtotime("$combine_EYKD "));
//$start_date1 = $sTime;
//$end_date1 =  $eTime;
//$start_date1 = date ("Y-m-d H:i:s", $start_date11);
...
include "config.php";
	...
	if($link){
				...
				*/
				...
				$sql = "insert into van_reserve (van_reserve_id, department, name, position, tel, ext, email,
					 start_date, end_date, Start_time, End_time, place, reason, people_total,

					 people_name1, people_position1, people_company1,
					  people_name2, people_position2, people_company2,
					 people_name3, people_position3, people_company3,
					  people_name4, people_position4, people_company4,
						people_name5, people_position5, people_company5,
						people_name6, people_position6, people_company6,

						company_driver, driver_id, driver_name, driver_position,
						driver_licence, status, create_date, update_date)

 							values('','$department','$name','$position','$tel','$ext','$email',
							'$datetime1','$datetime2','$Start_time','$End_time','$place','$reason','$people_total',
							...
							'$company_driver','$driver_id','$driver_name','$driver_position',
							'$driver_licence','$status',NOW(),NOW())" or die("ไม่พบฐานข้อมูล");
